...
export const fetchLawFirms = createAsyncThunk<LawFirm[]>(
...
export const createLawFirm = createAsyncThunk<LawFirm, Partial<LawFirm>>(
...
export const deleteLawFirm = createAsyncThunk<string, string>(
    ...
    builder
      ...
      .addCase(deleteLawFirm.fulfilled, (state, action) => {
        state.lawfirms = state.lawfirms.filter(
          (firm) => firm.id !== Number(action.payload)
        );
        state.status = "succeeded";
      });
  },
